...
namespace SharpTransition
{
	...
	public class Transition
	{
        ...
        static Transition()
        {
            ...
            registerType(new ManagedType_PointF());
            registerType(new ManagedType_Rectangle());
            registerType(new ManagedType_RectangleF());
            registerType(new ManagedType_Size());
            registerType(new ManagedType_SizeF());
        }
